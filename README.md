...
I used the that orange color (#FF9900) inspired by the hiring company Logo color, and used with it the light grey color based on Material Design Colors Palette, and the simple easy to use design inspired from the PDF file you provided in the task email.
